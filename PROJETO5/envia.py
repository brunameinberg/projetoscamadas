    ...
    try:
        ...
        while j <= numerodepacotes + 1:
            ...
            if j == 91:
                 ...
                 head = bytearray.fromhex('03' + '13' + '00') + qualpacoteembytes + qualpacoteembytes + tamanhopayloadpacote + bytearray.fromhex('00' + '00')
                 payload = txBuffer[(10259) : (10342)] #porção da imagem que será enviada
                 eop = bytearray.fromhex('AA'+'BB'+'CC'+'DD')
                 #arrumando byte 8 e 9 de head
                 expected = b'\x00\x00'
                ...
                head = bytearray.fromhex('03' + '13' + '00') + numerodepacotesembytes + qualpacoteembytes + tamanhopayloadpacote + bytearray.fromhex('00' + '00')
